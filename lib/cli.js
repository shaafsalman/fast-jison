/*
 * File: lib/cli.js
 * Source: Original file cli.js
 * Refactorings applied: 
 *   - Extract Method: Separated command line options handling
 *   - Consolidate Conditional Expressions: Simplified grammar processing
 * Functionality: Command-line interface for Jison
 */
...
cli.generateParserString = function generateParserString(opts, grammar) {
    ...
    // Create a generator and use its generate method
    var generator = new jison.Generator(grammar, settings);
    
    // The generate method is inherited from parserMethods
